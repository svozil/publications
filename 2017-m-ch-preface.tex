...
mathematical physicists look upon the theoreticians sceptically,
and
mathematicians look upon the mathematical physicists dubiously.
I have even experienced the distrust formal logicians expressed about their colleagues in mathematics!
...
Some people will claim that I am too confusing and utterly formalistic, others will claim my arguments are in desperate need of rigour.
...
\newthought{In 1987 in his} {\it Abschiedsvorlesung} professor Ernst Specker
...
\newthought{Zeno of Elea and Parmenides,} for instance, wondered how there can be motion if
...
how can there be motion if everything is not moving at all times \cite[-40mm]{zeno,benna:62,gruenbaum:68,Sainsbury}?
...
\newthought{The relationship between physics and formalism} has been debated by
...
\begin{marginfigure}
\includegraphics{2018-m-cartoon-Heaviside2}
...
It is good in modelling of, say, switching on and off electric currents, but it is nonsmooth and nondifferentiable.}
...
\newthought{It might be prudent} to
