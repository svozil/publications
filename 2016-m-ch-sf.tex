...
We also mention without proof the following formul\ae:
\begin{equation}
...
in particular,
$y_1(x) =  \sum_{l=0}^\infty (x-x_0)^{l + \sigma} w_l$ with $\sigma_{1} =  1$
into (\ref{2016-m-ch-sf-efmEu}).
In this case,
\begin{equation}
\begin{split}
z^2 \sum_{l=0}^\infty (l+1)l (x-x_0)^{l - 1} w_l
+
z \sum_{l=0}^\infty l (x-x_0)^{l} w_l
-
\sum_{l=0}^\infty   (x-x_0)^{l+1} w_l = 0,
\\
\sum_{l=0}^\infty \left[ w_l (l+1)l + w_l (l+1) -w_l \right] (x-x_0)^{l+1} w_l = 0,
\\
