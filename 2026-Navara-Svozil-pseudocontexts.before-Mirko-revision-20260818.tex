...
\begin{equation}
 ...
 M_{E,v}= %! _{Ev} could be misinterpreted
 \begin{cases}
  1,&v\in E,\\
  0,&v\notin E,
 \end{cases}
...
%! This is difficult to understand; at least an explanation is needed.
...
$v_{01},v_{12},\ldots,v_{70}$ its corners. %!, with indices modulo eight.  
The
...
\end{equation}
Thus every admissible weight $p$ %!
satisfies
\begin{equation}
