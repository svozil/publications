...
\title{\bf \color{white} {Quantum clouds and contextuality}}
\subtitle{ \color{white} {\footnotesize http://tph.tuwien.ac.at/$\sim$svozil/publ/2018-Svozil-Vaxjo2018-pres.pdf
%\\
...
\date{\textcolor{white!100}{UQT, V\"axj\"o, June 11-14, 2018}}
...
\item
predictions about what happens within the cloud, and at its endpoints
${\bf Alice}$
\&
${\bf Bob}$
are classical
...
$\widetilde{\qquad \qquad }$
\end{center}
For a (somewhat weaker) statement relative to global truth assignments, see
...
{{\color{magenta}clouds are merely in our mind, they represent our own subjective imagination \& construction}};
...
{{\color{magenta}clouds ``exist'' merely in our mind, they represent our own subjective imagination \& construction}};
...
\begin{frame}[fragile]{Some discussions/warnings related to realism versus idealism}

\begin{itemize}
\item
Sigmund Freud, {\em ``gleichschwebende Aufmerksamkeit (Engl. evenly-suspended attention)''}
 {{R}atschl{\"{a}}ge f{\"{u}}r den {A}rzt bei der psychoanalytischen {B}ehandlung}, {1912, 1999}
\item
 {Walter Terence Stace}, {\em The Refutation of Realism}, {\em Mind} {\bf 53}, 349-353 (1934),
 https://doi.org/10.1093/mind/XLIII.170.145
\item
Edwin Thompson Jaynes, {\em Mind Projection Fallacy: supposing that creations of our own imagination
are real properties of Nature, or that our own ignorance signifies some indecision on the
part of Nature.} The angry ``omelet papers'', 1988, 89
\end{itemize}
