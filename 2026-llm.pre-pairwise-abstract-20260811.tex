...
\begin{abstract}
After a brief introduction to finite-dimensional Hilbert-space geometry for
contextual representations, we use established concentration and coding
results to benchmark the coexistence of nearly orthogonal feature directions
and analyze interference for a specified linear readout.  We then propose
controlled tests of when a tied shared-subspace model of polysemy improves
sample efficiency.  The construction is classical, and no experiment is
reported.
\end{abstract}
