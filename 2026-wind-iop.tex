...
\author{Karl Svozil\footnote{corresponding author: \href{mailto:karl.svozil@tuwien.ac.at}{karl.svozil@tuwien.ac.at}}}
...
gearbox, and the lower rack (``ground'') moves backward with speed $v_f$; the
same symbol $v_f$ denotes the ground speed of the gearbox in \(G\).

\begin{figure*}[htbp]
\centering
\begin{tabular}{ccc}
\begin{tikzpicture}[scale=0.80,line cap=round,line join=round,>=Stealth,font=\small]
...
drift horizontally with negligible resistance. Bob attempts to reach Alice by
...
\item Introductory undergraduate physics/engineering: Rates of mechanical energy transfer (power), efficiency, drag scaling, turbines vs fans, idealizations vs nonidealities.
...
\item Explain how static friction can transmit force without doing work in the ground frame; identify where mechanical energy enters and leaves the system and the corresponding rates of transfer (power).
...
\item Frame confusion: mixing air-frame and ground-frame velocities and rates of energy transfer (powers).
