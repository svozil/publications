...
The foundational algebraic structures and verification routines discussed in this paper are accompanied by a complete Lean~4 formalization workspace. This external proof certificate compiles successfully via the standard \texttt{lake build} system and contains no logical gaps or placeholders. The verbatim source files and configuration toolchains are permanently archived on Zenodo~\cite{svozil-2026-softmax-sup-LeanArtifact2026} and can be audited independently of this manuscript.
