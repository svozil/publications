...
``$X^{i_j}$.''
The lower index $j$ does {\em not} correspond to any covariant entity but just indexes the $j$th vextor ${\bf x}_j$.
}
\begin{equation}
...
``$X_{i_j}$.''
The upper index $j$ does {\em not} correspond to any contravariant entity but just indexes the $j$th vextor ${\bf x}^j$.
}
\begin{equation}
