...
is used to indicate that its terms and solutions just depend on a single one independent variable.
...
\end{split}
\end{equation}
Therefore, Equation (\ref{2011-m-ch-slspbtfao1aaa}) reduces to, and
