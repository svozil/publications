...
if
\begin{equation}
\lim_{x\rightarrow x_0} \left[ (x-x_0)\frac{ a_1(x)}{a_2(x)}\right]\textrm{, as well as }
...
In order to analyse the singularity at infinity we have to transform the equation by $z=1/t$.
First observe that
$p_1(z)= 1/z$
and
$p_2(z)= -1/z^2$.
