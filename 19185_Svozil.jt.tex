...
by Bennett {\&} Brassard\cite{benn-82,benn-84,ekert91,benn-92,gisin-qc-rmp} in 1984 henceforth called ``BB84''.
Since
...
depending on the eyeglass through which it is viewed.[xx changed wording xx]
We will present an explicit example featuring complementarity, which is similar in many ways to
quantum complementarity.[xx changed wording xx]

The difference between the chocolate(black) balls and quanta is the possibility
...
The protocols and
procedures used with the quasi-classical chocolate ball model appear very similar
...
the measurements (such as the mono-colored glasses) which prevent us
...
by two agents called Alice and Bob. To do so, the following
utensils depicted in Fig.~\ref{2005-ln1e-utensils} will be required:
\begin{figure}
\begin{center}
 \includegraphics[width=8.2cm]{Svozil1}% was 2005-ln1e-utensils}
\end{center}
...
inside the urn. There are four types of balls, which are
listed in Table \ref{2005-nl1-t1}. There needs to be an equal number
...
\item[(3)]
Ideally, but not necessarily some actors who know
...
Chocolates marked with the symbols 0 and 1 in green, correspond
...
rotated by 45$^o$ ($\pi / 4$) from the horizontal and the vertical,
respectively.
...
\begin{itemize}
\item[(1)]
Alice flips a coin to chose one of two pairs of glasses: heads is
...
This situation is illustrated in Fig.~\ref{f-gum-w}. She
...
coin to choose one pair of glasses. Again, heads is for the green,
...
and 1.
The random key [xx where did this come from? what random key are you talking about? xx] can be used in many
cryptographic applications, for instance as one-time pad (like TANs [xx what are TANS? xx] in
online banking).
...
Thus, if Alice and Bob compare some of their symbols, they could realize that Eve is listening.
...
First,  we define one of two possible ``contexts'' or
colors; in this case either red or green.
Then we randomly measure[xx what do you by measure? to you simply mean pick red or green randomly? xx]  another color, which is independent of this
...
An equal
amount of each type of figure is placed inside an urn. No colored glasses
...
\begin{itemize}
\item[(1)]
First, Alice randomly draws one figure from the urn and makes a note
...
and presented by the quantum (red figure--red draw or green figure--green draw), the symbol of the
...
[xx the point of this protocol is not clear xx]
...
It is allowed to carry out peaceful attacks  to eavesdrop on the
...
The photographs in Fig.~\ref{2005-ln1e-pics}b)-f) depict some stages of the performance.
...
\begin{center}
\begin{tabular}{lr}
 \includegraphics[width=7.2cm]{Svozil2}% was 2005-ln1e-catwalk}
&
 \includegraphics[width=7.2cm]{Svozil3}% was 2005-ln1e-svozil}
\\
...
\begin{center}
\begin{tabular}{lr}
\multicolumn{2}{c}{ \includegraphics[width=15cm]{Svozil4}}% was 2005-ln1e-q1}}
\\
\multicolumn{2}{c}{(c)}\\
\multicolumn{2}{c}{ \includegraphics[width=15cm]{Svozil5}}% was 2005-ln1e-q2}}
\\
\multicolumn{2}{c}{(d)}\\
\end{tabular}
\end{center}
...
\begin{tabular}{lr}
$\;$\\
\multicolumn{2}{c}{ \includegraphics[width=15cm]{Svozil6}}% was 2005-ln1e-q3}}
\\
\multicolumn{2}{c}{(e)}\\
\multicolumn{2}{c}{ \includegraphics[width=15cm]{Svozil7}}% was 2005-ln1e-flag}}
\\
\multicolumn{2}{c}{(f)}\\
\end{tabular}
\end{center}
