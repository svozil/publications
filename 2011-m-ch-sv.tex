...
to solve a problem by separation and joining together
-- for a counterexample see the Kochen-Specker theorem on page \pageref{2011-m-KST})
...
but it is a very important one in physics.
...
can be very often used whenever the
{\em Laplace operator}
