...
\title{Semantic Concurrency, Context, and Polysemy in Large Language Models}
...
operations: it would need to identify a role for contextual frames,
...
effective dimension and coactivation.  The hinge-and-frame organization is
...
States, contexts, frames, interference terms, noncommuting questions, or
...
the hinge hypothesis is an empirically testable proposal about the internal
organization of a classical model.  Its language of shared vectors and
alternative frames creates a structural correspondence with the second
level, but the correspondence would become a specifically quantum-like
model only after additional ingredients---for example, noncommuting frame
updates or phase-sensitive interference---were formally specified and shown
to make discriminative predictions.  The tests in
Sec.~\ref{sec:predictions} therefore target the hinge hypothesis itself; they
...
represent a state relative to alternative contexts or frames and may add
noncommuting updates, interference terms, or a measurement-like selection
rule.  The hinge-and-frame construction offers a possible bridge to that
...
the decisive next step: comparing the hinge-and-frame model and any stronger
