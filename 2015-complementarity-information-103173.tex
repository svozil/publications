\documentclass[information,article,submit,moreauthors,pdftex,12pt,a4paper]{mdpi}
...
\Author{Alastair A. Abbott $^{1,2,3}$*, Cristian S. Calude $^{1}$ and Karl Svozil $^{4,1}$}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ Department of Computer Science, University of Auckland,
Private Bag 92019, Auckland, New~Zealand\\
$^{2}$ Centre Cavaill\`es, R\'epublique des Savoirs, USR 3608, CNRS, Coll\`ege de France and \'Ecole Normale Sup\'erieure, 29 rue d'Ulm, 75005 Paris, France\\
...
\corres{\texttt{a.abbott@auckland.ac.nz}}

% Abstract (Do not use inserted blank lines, i.e. \\)
\abstract{
% Must be < 200 words, 1 paragraph only
%
...
In this paper, we continue the programme started in~\cite{DBLP:conf/birthday/AbbottCS15} developing a general, non-probabilistic model of (un)predictability in physics.
We present a more refined model that is capable of studying different degrees of ``relativised'' unpredictability.
This model is based on the ability for an agent, acting via uniform, effective means, to predict correctly and reproducibly the outcome of an experiment using finite information extracted from the environment.
We use this model to study further the degree of unpredictability certified by different quantum phenomena, showing that quantum complementarity guarantees a form of relativised unpredictability that is weaker than that guaranteed by Kochen-Specker-type value indefiniteness.
...
\newblock {\em Journal of Modern Optics} {\bf 2000}, {\em 47},~595--598.
...
\newblock {\em Journal of Mathematics and Mechanics (now Indiana University
  Mathematics Journal)} {\bf 1967}, {\em 17},~59--87.

\bibitem[Bell(1966)]{bell-66}
Bell, J.S.
\newblock On the Problem of hidden variables in quantum mechanics.
\newblock {\em Reviews of Modern Physics} {\bf 1966}, {\em 38},~447--452.
...
\newblock {\em Nature Physics} {\bf 2010}, {\em 6},~659--662.
...
\newblock Can quantum-mechanical description of physical reality be considered
  complete?
\newblock {\em Physical Review} {\bf 1935}, {\em 47},~777--780.
...
\newblock {\em Information and Computation} {\bf 2009}, {\em 207},~660--669.

\bibitem[Devaney(1989)]{Devaney-1989}
Devaney, R.L.
\newblock {\em An Introduction to Chaotic Dynamical Systems}, second ed.;
...
\newblock {\em Review of Modern Physics} {\bf 2002}, {\em 74},~145--195.
...
\newblock Strong {K}ochen-{S}pecker theorem and incomputability of quantum
  randomness.
\newblock {\em Physical Review A} {\bf 2012}, {\em 86},~062109.
...
\newblock {\em Zeitschrift f{\"{u}}r Physik} {\bf 1927}, {\em 43},~172--198.
...
\newblock {\em Journal of Mathematical Physics} {\bf 2014}, {\em 55},~042111.

\bibitem[Cowen(2013)]{Cowen:2013fe}
Cowen, R.
\newblock Proof mooted for quantum uncertainty.
\newblock {\em Nature News} {\bf 2013}, {\em 498},~419--420.
...
\newblock Violation of {H}eisenberg's Measurement-Disturbance Relationship by
  Weak Measurements.
\newblock {\em Physical Review Letters} {\bf 2012}, {\em 109},~100404.

\bibitem[Robertson(1929)]{Robertson:1929ee}
Robertson, H.P.
\newblock The Uncertainty Principle.
\newblock {\em Physical Review} {\bf 1929}, {\em 34},~163--164.

\bibitem[Popper(1992)]{Popper:1992ty}
Popper, K.R.
\newblock {\em Quantum Theory and the Schism in Physics}; Routledge,  1992.

\bibitem[Gold(1965)]{Gold:1965qd}
Gold, E.M.
\newblock Limiting Recursion.
\newblock {\em The Journal of Symbolic Logic} {\bf 1965}, {\em 30},~28--48.

\bibitem[Bohm(1952)]{Bohm52}
Bohm, D.
\newblock A Suggested Interpretation of the Quantum Theory in Terms of
  ``Hidden'' Variables. {I,II}.
\newblock {\em Physical Review} {\bf 1952}, {\em 85},~166--193.
