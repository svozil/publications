...
\title{\bf \textcolor{blue}{Conceptualizing Quantum Music\\Quantum Musical Space}}
\subtitle{\url{http://tph.tuwien.ac.at/~svozil/publ/2021-QMusic-pres.pdf}}
\author{Karl Svozil}
...
\date{Online presentation, Friday, November 19, 2021}
\maketitle
...
\begin{itemize}
\item[$\bullet$] {\color{purple} Volkmar Putz, University College of Teacher Education in Vienna (P\"adagogische Hochschule Wien), Vienna, Austria}

\pause
\item[$\bullet$] {\color{purple}Publications}
\begin{itemize}
...
\item[$\ast$] {\color{blue}   Volkmar Putz and Karl Svozil, ``Quantum music, quantum arts and their perception'', arXiv:2108.05207 (2019), submitted to {\it ``Quantum Computing in the Arts and Humanities'', E. R. Miranda (Ed.), 2022}}
\end{itemize}
\end{itemize}
}
...
\section{Quantum musical expressions}

\frame{
 \frametitle{Quantum musical tones}
\begin{center}
\begin{music}
\startextract
...
forming the octave basis ${\mathfrak B}$ of $\mathbb{C}^7$:
...
\frame{
 \frametitle{Bundling octaves into single tones, compositions thereof}
...
\frame{
 \frametitle{Classical perception of quantum musical parallelism}
...
\frame{
 \frametitle{Entangled music, complementarity and contextuality}
Please see our papers for a first inroad into these subjects~$\ldots$
\begin{center}
