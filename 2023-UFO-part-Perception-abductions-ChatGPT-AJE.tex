...
For instance, reports of UFO sightings by commercial airline pilots and air traffic controllers began to increase after the
...
(One name dropped in this connection is Richard Doty\index{Doty, Richard}, but as I cannot confirm nor disprove this claim I leave it at that.)
...
of Americans may have experienced the ``UFO Abduction Syndrome.'' Don Crosbie Donderi\index{Donderi, Don Crosbie} claims to be able to use a questionnaire to determine with a high level of certainty if a person has been abducted~\cite{Donderi2013Jun}.
...
In this line of speculation, and similar to \index{Le Poer Trench, Brinsley}Brinsley Le Poer Trench's
