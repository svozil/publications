...
waiting schedule. A computable process law produces Martin-L\"of-random
records almost surely, while finite observations cannot certify randomness;
...
test. Such records have measure one, but finite samples cannot certify this
infinite-sequence property. No-arbitrage supplies a separate
...
& Independent fair trials yield ML-random records almost surely; finite
tests cannot certify randomness \\
No-arbitrage
...
events undecidable; and a computable probability law links process randomness
...
change has conditional mean zero, even given the trader's private seed.
Under integrability this gives zero expected gain at each fixed horizon,
