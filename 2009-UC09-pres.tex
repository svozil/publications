...
\addfootboxtemplate{\color{structure!65}}{\color{white}\tiny \hfill Quantum Recursion Theory\hfill}
\addfootboxtemplate{\color{structure!50}}{\color{white}\tiny \hfill UC09 Ponta Dalgada,  Sept. 8, 2009\hfill}
...
\title{\bf \textcolor{red}{On the brightness of the Thomson lamp.\\ A prolegomenon to quantum recursion theory}}
...
\subtitle{\textcolor{orange!60}{\small http://tph.tuwien.ac.at/$\sim$svozil/publ/2009-UC09-pres.pdf}\\
\textcolor{gray!60}{\footnotesize http://arxiv.org/abs/0904.1649}
}
\author{Karl Svozil}
...
\date{Unconventional Computation 2009\\
...
One could proceed a step further and allow
