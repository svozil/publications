...
%First version: 2010 (Sevilla).
%This version: March 28, 2014 (Sevilla)
...
biconnected graphs of minimal valence two, not containing cycles on length four, and containing at least two triangles.}
\end{figure}
...
%
 ...
 \draw (2) coordinate[c1,fill=green];
 %
 \draw (3) coordinate[c2,fill=blue,label=90:$v_3$];
 ...
 \draw (7) coordinate[c1,fill=magenta];
 %
 \draw (8) coordinate[c3,fill=magenta,label=0:$v_8$];
 \draw (8) coordinate[c2,fill=brown];
 \draw (8) coordinate[c1,fill=lime];

 %\draw (8) coordinate[c1,fill=red];
 %
 %\draw (9) coordinate[c4,fill=brown];
 \draw (9) coordinate[c3,fill=gray,label=270:$v_{10}$];
 \draw (9) coordinate[c2,fill=violet];
 \draw (9) coordinate[c1,fill=brown];

 \draw (10) coordinate[c3,fill=gray,label=270:$v_9$];
