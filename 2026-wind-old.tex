...
Three times, actually — lines 1496, 1505, and 1529.
Line 1529 is the same kind of redundant gloss, just with the plural form " (powers)" instead of " (power)". The referee's comment applies equally to both forms, since the issue is the parenthetical repetition after the definition has been given, not the specific singular/plural wording.
So the full set of deletions is:

Line 1496: delete " (power)"
Line 1505: delete " (power)"
Line 1529: delete " (powers)"

If you'd rather only do two, lines 1496 and 1505 are the ones the referee is most likely to have had in mind (they're the more prominent ones, in the pedagogical learning-objectives lists), but for consistency I'd include 1529 since leaving it would create an odd asymmetry where two of three identical constructions got trimmed and one didn't.
