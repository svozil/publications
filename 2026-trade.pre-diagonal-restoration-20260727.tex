...
Ville's inequality, Martin-L\"of randomness, computable randomness, and
Schnorr randomness connect the probabilistic and computational regimes
without requiring an adaptive adversary; their different effective tests are
stated explicitly. A path-measure likelihood ratio yields an integral
fluctuation identity, while Kelly's theorem prices side information in
expected-log-wealth units. Finally, put--call parity identifies the Wheel as a
rolled short-put exposure whose possible average premium compensates
downside and volatility risk. Cover's universal portfolio, relative
arbitrage, and economically viable information rents remain possible because
their guarantees are benchmark- or distribution-relative, not universal
absolute profit.
\end{abstract}
...
\begin{enumerate}
  ...
  hierarchy of Martin-L\"of, computable, and Schnorr randomness describes
...
Under a passive computable fair measure, Ville's inequality and
Martin-L\"of randomness show instead that a measure-one set of typical paths
prevents unbounded success by every lower-semicomputable nonnegative
supermartingale. Computable and Schnorr randomness give related but strictly
weaker effective tests. None of these statements should be substituted for
another, and none turns uniform NFL averaging into a model of empirical
returns.
