...
Indeed, this bound on the target dimension of this embedding is tight~\cite{larsen-nelson-2017}.

This preservation of distances translates into the preservation of inner products.
The proof of the Johnson-Lindenstrauss lemma relies on the property that a random projection
strongly preserves the norms of vectors. By applying the (real) polarization
identity, $\bm{u} \cdot \bm{v} = \frac{1}{2} \left( \|\bm{u}\|^2 + \|\bm{v}\|^2 - \|\bm{u} - \bm{v}\|^2 \right)$,
the preservation of the norms of the position vectors and their differences---and thus the distances of the respective points---ensures that pairwise inner products are also preserved to within a small
