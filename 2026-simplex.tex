...
\begin{abstract}
Classicality tests for finite quantum logics are not interchangeable: they depend on whether one retains incidence data, operational probability data, or operator-algebraic product data. This paper compares three distinct families of such tests. Incidence-level tests are formulated in terms of valuations, colorings, and partition-logical representations. Operational tests ask whether a given prepare-and-measure table admits a classical simplex embedding. Operator-functional tests impose spectral and product rules on observable values.
\end{abstract}
