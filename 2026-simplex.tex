...
the Minkowski-Weyl theorem~\cite{ziegler,Henk-Ziegler-polytopes,Avis:1997:GCH:280651.280652,mcmullen-71,Schrijver,gruenbaum-2003,Fukuda-techrep}
every polytope has equivalent  descriptions,  by finite sets of vertices ($V$-representation) and of facet (in)equalities ($H$-representation).
...
Large language models were used for editorial assistance, local consistency checks, and drafting of alternative phrasings.  The mathematical claims, examples, computational inputs, and final responsibility for the text are the author's.
\end{acknowledgments}
