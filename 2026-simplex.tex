...
This geometric difference can nevertheless show up at an almost trivial
...
The clean example is a polarization or spin analyzer rotated against a fixed
...
more common atoms, do not by themselves produce an operational obstruction.
...
The preceding local observations should therefore not be confused with a
classical reconstruction of quantum theory.  They identify where, and under
which limited circumstances, the one-context and bare two-context shadows may
be considered classically reproducible, and where additional operational or
marginal constraints must enter.  Once a sufficiently rich family of contexts
...
The supplementary archive accompanying this revision contains the ray
