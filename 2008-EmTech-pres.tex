...
\addfootboxtemplate{\color{structure!50}}{\color{white}\tiny \hfill SS 2008\hfill}
...
\subtitle{\textcolor{orange!60}{http://tph.tuwien.ac.at/$\sim$svozil/publ/2008-EmTech-pres.pdf}}
\author{Karl Svozil}
...
\frame{
\frametitle{Quantum information \& computation}
...
\put(39.102,26.698){\dashbox{1}(9.565,6.832)[cc]{}}
\put(43.622,22.914){\makebox(0,0)[cc]{$B$}}
\end{picture}
\end{center}
...
\frame[shrink=1.01]{
\frametitle{``Bomb'' detection without explosion}
\begin{itemize}
\item<+->
No bomb present:
...
$$
The emitted quant is detected with 50:50 chance in $D_1$ or $D_2$.
Thus, if $D_2$ clicks, we have certainty that the bomb is present without exploding it.
\end{itemize}
}
