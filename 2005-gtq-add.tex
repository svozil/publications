...
\author{Karl Svozil}
\author{Boris Kamenik} %? die Email/URL-Fußnote sollte sich nur auf author{Svozil} beziehen
...
%and the discussion of fundational issues
...
%(unklar formuliert, stimmt ausserdem nicht für tau = n pi/3)
...
We can now turn to the calculation of quantum predictions.
...
probability expected for unentangled particles, as shown in Fig.~\ref{2005-gtq-plots2}.
...
\bibinfo{author}{\bibfnamefont{G.}~\bibnamefont{Krenn}} \bibnamefont{and}
  ...
  (\bibinfo{year}{1996}),
  \urlprefix\url{http://dx.doi.org/10.1103/PhysRevA.54.1793}.

\bibitem[{\citenamefont{Ballentine}(1989)}]{ba-89}
\bibinfo{author}{\bibfnamefont{L.~E.} \bibnamefont{Ballentine}},
  \emph{\bibinfo{title}{Quantum Mechanics}} (\bibinfo{publisher}{Prentice
  Hall}, \bibinfo{address}{Englewood Cliffs, NJ}, \bibinfo{year}{1989}).
...
\bibitem[{\citenamefont{Svozil}(2005)}]{svozil-2004-vax}
\bibinfo{author}{\bibfnamefont{K.}~\bibnamefont{Svozil}}, in
  \emph{\bibinfo{booktitle}{AIP Conference Proceedings 750. {F}oundations of
  Probability and Physics-3}}, edited by
  \bibinfo{editor}{\bibfnamefont{A.}~\bibnamefont{Khrennikov}}
  (\bibinfo{publisher}{American Institute of Physics},
  \bibinfo{address}{Melville, NY}, \bibinfo{year}{2005}), pp.
  \bibinfo{pages}{351--360}, \eprint{quant-ph/0406014},
  \urlprefix\url{http://dx.doi.org/10.1063/1.1874586}.

\bibitem[{\citenamefont{Gill}(2003)}]{gill-03}
\bibinfo{author}{\bibfnamefont{R.~D.} \bibnamefont{Gill}}, in
  \emph{\bibinfo{booktitle}{Proceedings of Foundations of Probability and
  Physics-2}}, edited by
  \bibinfo{editor}{\bibfnamefont{A.}~\bibnamefont{Khrennikov}}
  (\bibinfo{publisher}{V{\"a}xj{\"o} Univ. Press}, \bibinfo{year}{2003}), pp.
  \bibinfo{pages}{179--206}, \eprint{quant-ph/0301059}.
