...
\title{\textcolor{blue}{\bf Contextuality by nonembeddibility, the connection between two-valued states and coloring as well as reconstruction of (hyper)graphs, and extending Kolmogorov's axioms for collections of contexts}}
\subtitle{\footnotesize \url{http://tph.tuwien.ac.at/~svozil/publ/2022-Tropea-pres.pdf}
\\
...
\date{{\color{purple}Monday, June 27, 2022, Fifteenth Biennial Quantum Structure 2022 Conference, Tropea, Calabria, Italy}}
\maketitle
...
\section{Contextuality by nonembeddibility}

\frame{
 \frametitle{Advertisement: Contextuality by nonembeddibility}

KS, ``Varieties of contextuality based on probability and structural nonembeddability'', Theoretical Computer Science 924 117-128 (2022) \href{https://doi.org/10.1016/j.tcs.2022.04.039}{DOI 10.1016/j.tcs.2022.04.039}

\begin{itemize}
\item[$\bullet$]
Kochen and Specker's Theorem~0 in \href{https://doi.org/10.1512/iumj.1968.17.17004}{DOI 10.1512/iumj.1968.17.17004}
serves as a demarcation criterion for
embeddibility into ``extended'' Boolean algebras; eg, via partition logics obtained from the set of all two-valued states.


\item[$\bullet$]
This (as well as nonunitality etc) can be associated with strong forms of contextuality even in the presence of two-valued states.
\end{itemize}
...
\frame{
 \frametitle{Advertisement and challenge: Find a True-Implies-False (TIFS) gadget with ``aperture'' $\pi /2$}

Mohammad H. Shekarriz and KS, ``Noncontextual coloring of orthogonality hypergraphs'', Journal of Mathematical Physics 63 (3), 032104 (2022) \href{https://doi.org/10.1063/5.0062801}{DOI 10.1063/5.0062801}
...
\begin{itemize}
\item[$\bullet$]
the set of two-valued states and coloring of (hyper)graphs;


\item[$\bullet$]
the set of two-valued states and reconstruction of (hyper)graphs.
\end{itemize}

}

\frame{
 \frametitle{Interesting hypergraph: Greechie's $G_{32}$}
...
pps: Any proof that a faithful orthogonal representation of a TIFS with aperture $\pi /2$ might ultimately require geometric means.
