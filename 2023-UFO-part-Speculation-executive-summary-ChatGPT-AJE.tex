...
(i) One in which no alien intrusion occurred but waves of mass hysteria created mistaken UFO sightings, with governments everywhere trying to calm down their populations, dealing with an avalanche of reports, and a press that sells sensational cases.
...
(iii) The last scenario involves the Others dictating strict nonfraternization while pursuing their interests, particularly breeding and reproduction, by abducting a sizable portion of humans.}
...
This scenario basically follows Oliver Harry Turner's\index{Turner, Oliver Harry} recollection~\cite{TurnerAustralia1971}.
...
such as von Neumann,\index{von Neumann, John} Eric Walker\index{Walker, Eric} and Vannevar Bush,\index{Bush, Vannevar} as well as military and government officials, were involved.
