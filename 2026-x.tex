...
models share, since ornate formal prose can conceal rather than clarify. The
inverse lesson is Schr\"odinger's early wave mechanics: the physicist's Ansatz
required mathematical closure, and the special-function machinery of the hydrogen
problem was not ornament but part of the result; biographical accounts connect
that closure with exchanges involving Hermann
Weyl~\cite{ANDP:ANDP19263840404,Moore-Schroedinger}. The moral does not need the
strongest version of the anecdote. The result was neither image alone nor
formalism alone. It was the coupling.
