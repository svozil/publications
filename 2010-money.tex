...
%\part{Setting the stage $\quad$}

\chapter{Preface}


\begin{chapterquote}
No one is more a slave than the man who thinks himself free while he is not.\footnote{
German original: Niemand ist mehr Sklave, als der sich f\"ur frei h\"alt, ohne es zu sein.
({\em Johann Wolfgang von Goethe}, in {\it Die Wahlverwandtschaften}.)}
...
%\section{Anecdotes}
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{A}}{fter} ridding themselves from a nuclear power plant just after its completion,
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{A}}{ couple} of years ago, as we were having lunch
at the cafeteria,
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{T}}{he} common citizen has been deceived into believing that money is a relatively benign, passive
...
\chapter{Remarks on methodology}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{M}}{oney} appears to be one of the most amazing and mind-boggling entities:
...
\part{Money creation balanced by some thing $\quad$}

\chapter{Commodity versus fiat money}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{W}}{hen} it comes to ``paying'' some thing with another thing\footnote{
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{F}}{iat} money comes in very different forms.
...
\section{Historic money based on  reserve banking}
...
\section{Fiat money based on fractional reserve banking as we know it}
...
\subsection{Boot money generated by central banks}
...
the
{\em Niederösterreichische Versicherung}       holding  about 0.53\%,
the
...
the
{\em Raiffeisenlandesbank Oberöstereich}       holding  about 0.07\%,
the
{\em Raiffeisenlandesbank Burgenland}  holding  about 0.07\%,
and the
{\em Raiffeisenlandesbank Kärnten}     holding  about 0.07\%
of the shares.
}
\end{itemize}

\subsection{Secondary money generated by commercial banks}
...
\section{Government created fiat money as we do not know it}
...
\section{Which tail wags which dog?}
...
\chapter{Monetization as {\em nothing for some thing}}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{S}}{uppose} somebody
...
\chapter{Value and price of things not traded}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{W}}{hat} does an alleged loss
...
\chapter{Value and price of traded things}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{F}}{or} those things traded the value or
...
\chapter{Limits to fiat monetization}



\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{C}}{ould}
...
\chapter{Absence of a counterbalance between fiat money and assets}




\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{I}}{deally},
...
\chapter{Fiat fantasies {\em versus} deficit spending}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{I}}{n}
...
\part{Money creation by expectations $\quad$}

\chapter{Indirect fiat monetization by expectations}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{S}}{ome} nonbank agents  such as explorers, invaders, investors or inventors  require money for future profits.
...
\chapter{Interest as tax and appropriation}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{A}}{s}
...
\chapter{Credit as egalitarian instrument}
...
\chapter{Consequences of no or low interest}
...
\chapter{Plasticity of interest rates}

\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{W}}{hy} should a noncentral bank not offer loans
...
\part{Instabilities \& Unknowables $\quad$}




\chapter{Is interest sustainable?}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{T}}{he}   (exponentially)   fast  growing {\em compound interest} \index{compound interest}
...
\chapter{Containment and osmosis of money types}

\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{I}}{f}   the markets are relatively isolated,
...
\chapter{Pricing ambiguities}




\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{T}}{he}  belief
...
\chapter{Formal incompleteness of macroeconomics}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{R}}{elated}
...
\chapter{Conjecture of balanced trading}


\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{I}}{t}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{F}}{iat} money is unbounded by any supply constraints, as it can be produced almost cost-free.
...
\section{Business cycles of inflation and deflation}

%\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{B}}{y}
...
\section{The perpetual money machine}
...
\chapter{Strategies to get rid of debt}
\label{stgrod}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{N}}{ot} everybody can get rid of debt by eliminating his creditors by killing them.
...
\section{Monetization of debt and (hyper)inflation}
...
\section{Bankruptcy and ``haircuts''}
...
\chapter{Anything that can go wrong, will go wrong}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{T}}{he}  various forms of money multiplication
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{W}}{hat} kind of appropriation of wealth should we adopt?
...
\section{Optimizing the distribution of happiness and well-being}
...
\section{Ambivalent perception of (in)stability}
...
\lettrine[lines=3, lraise=0.1]{\textcolor[gray]{0.5}{S}}{ome} very general options for monetary systems have been enumerated and compared.
