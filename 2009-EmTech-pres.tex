...
\addfootboxtemplate{\color{structure!50}}{\color{white}\tiny \hfill SS~2009\hfill}
...
\subtitle{\textcolor{orange!60}{\small http://tph.tuwien.ac.at/$\sim$svozil/publ/2009-EmTech-pres.pdf}}
\author{Karl Svozil}
...
some task; e.g., cooking.  It involves ``paper--\&--pencil operations.''
\begin{center}
\includegraphics[width=3.5 true cm]{PaperAndPencil.pdf}
\includegraphics[width=9 true cm]{cooking-11697-large.pdf}
\end{center}
}
...
\begin{center}
\includegraphics[width=4 true cm]{alien.pdf}
\end{center}
}
...
\begin{center}
\includegraphics{emtech-demon-op.pdf}
\end{center}
}
