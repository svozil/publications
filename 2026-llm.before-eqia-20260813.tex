...
orthonormal contexts.  The quantum comparisons are structural and deliberately
limited.  Mathematical details are relegated to undergraduate-level
appendices.
\end{abstract}
...
comparisons.  Formal statements and derivations appear in the appendices,
where every symbol is defined as it is introduced.
