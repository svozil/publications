...
And here is an opinion from ``the other end of the spectrum'' spanned by mathematical formalism on the one hand,
...
\newthought{Let us just mention} some concrete examples of the perplexing varieties of proof methods used today.
...
\newthought{Another altogether different issue} is knowledge acquired by revelation or by some authority.
