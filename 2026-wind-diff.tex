...
\usepackage{xcolor} % Added for highlighting changes
\usepackage{tikz}
...
Again, propulsion arises only because the ground provides an external reaction surface \textcolor{blue}{that} allows the drivetrain to exchange momentum between the two media.
